<script>
	...
	import { authStore, offlineStore, saveSubmissionOffline, isFormDownloaded } from '$lib/api.js';
	...
	async function handleSubmit() {
		...
		try {
			...
			submitMessage = 'Form submitted successfully! Data saved locally and will sync when online.';
...
<div class="container">
	{#if error && !isFormAvailable}
		<div class="card">
			<h2 class="text-lg font-bold mb-4">📱 Form Not Available Offline</h2>
	...
	{:else if form}
		...
		<div class="card">
			<div style="display: flex; justify-content: space-between; align-items: center;">
				...
				<button class="btn-secondary" style="width: auto; padding: 0.5rem 1rem;" on:click={goBack}>
					← Back
				</button>
			</div>
		</div>
		...
		<form on:submit|preventDefault={handleSubmit}>
			...
			<div class="card">
				...
				<p class="text-gray-600 text-center mt-4">
					💾 Your data will be saved locally and synced when you're online
				</p>
			</div>
		</form>
	{:else}

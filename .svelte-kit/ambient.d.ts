...
declare module '$env/static/private' {
	...
	export const EFC_15936_1592913036: string;
	...
	export const PB_ALLOWED_ORIGINS: string;
	export const PB_COOKIE_HTTP_ONLY: string;
	export const PB_COOKIE_SAME_SITE: string;
	export const PB_COOKIE_SECURE: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		PATH: string;
		PATHEXT: string;
		PB_ALLOWED_ORIGINS: string;
		PB_COOKIE_HTTP_ONLY: string;
		PB_COOKIE_SAME_SITE: string;
		PB_COOKIE_SECURE: string;
